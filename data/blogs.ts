// data/blogs.ts - 12 FULL Wellness Blogs (Ashwagandha length each)
...
`,
  ...
  {
    id: 3,
    title: "Holistic Immune System Optimization",
    slug: "holistic-immune-system-optimization",
    excerpt:
      "Support your immune system naturally by optimizing gut health, activating NK cells, and balancing cytokines with science-backed protocols.",
    category: "Health",
    date: "March 10, 2026",
    readTime: "9 min read",
    image: "/images/product-immune.jpg",
    references: [
      {
        title: "The gut microbiome and immune system interactions",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4894526/",
      },
      {
        title: "Natural compounds for enhancing immune function",
        url: "https://pubmed.ncbi.nlm.nih.gov/30446435/",
      },
      {
        title: "Cytokine balance and immune regulation",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7152112/",
      },
    ],
    content: `
<h1 style="font-size:32px;margin-bottom:16px;"><strong>Holistic Immune System Optimization</strong></h1>
...
`,
  ...
  {
    id: 4,
    title: "Hibiscus Tea for Heart Health",
    slug: "hibiscus-tea-heart-health",
    excerpt:
      "Hibiscus tea has been shown to support cardiovascular health, lower blood pressure, reduce cholesterol, and provide antioxidant protection.",
    category: "Wellness",
    date: "March 8, 2026",
    readTime: "8 min read",
    ...
    references: [
      {
        title: "Hibiscus sabdariffa and cardiovascular health",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4446522/",
      },
      {
        title: "Effects of Hibiscus tea on blood pressure",
        url: "https://pubmed.ncbi.nlm.nih.gov/20358384/",
      },
      {
        title: "Antioxidant and anti-inflammatory properties of Hibiscus",
...
`,
  ...
  {
    id: 5,
    title: "Kombucha: Fermented Tea for Digestive and Immune Support",
    slug: "kombucha-gut-health",
    excerpt:
      "Kombucha is a fermented tea rich in probiotics, organic acids, and antioxidants. It supports gut health, digestion, and overall immunity.",
    category: "Wellness",
    date: "March 5, 2026",
    readTime: "8 min read",
    ...
    references: [
      {
        title: "Kombucha Tea: Microbiology, Composition, and Health Benefits",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4696435/",
      },
      {
        title: "Effects of Kombucha on gut microbiota and immunity",
        url: "https://pubmed.ncbi.nlm.nih.gov/30858552/",
      },
      {
        title: "Fermented foods and digestive health",
...
`,
  ...
  {
    id: 6,
    title: "Adaptogens for Energy, Focus, and Resilience",
    slug: "adaptogens-energy-vitality",
    excerpt:
      "Adaptogenic herbs like Rhodiola, Ginseng, and Ashwagandha help your body manage stress, enhance energy, and maintain mental clarity.",
    category: "Wellness",
    date: "March 2, 2026",
    readTime: "8 min read",
    image: "/images/product-adaptogens.jpg",
    references: [
      {
        title: "Adaptogens in mental and physical performance",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3991026/",
      },
      {
        title: "Rhodiola rosea improves mental performance under stress",
        url: "https://pubmed.ncbi.nlm.nih.gov/19786254/",
      },
      {
        title: "Panax ginseng and fatigue management",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3659618/",
      },
    ],
    content: `
...
`,
  ...
  {
    id: 7,
    title: "Sleep Optimization with Natural Herbs",
    slug: "sleep-optimization-natural-herbs",
    excerpt:
      "Discover how natural herbs like Valerian, Chamomile, and Ashwagandha can improve sleep quality, reduce insomnia, and support healthy circadian rhythms.",
    category: "Wellness",
    date: "February 28, 2026",
    readTime: "8 min read",
    image: "/images/product-sleep-herbs.jpg",
    references: [
      {
        title: "Valerian root for sleep disorders",
        url: "https://pubmed.ncbi.nlm.nih.gov/22508205/",
      },
      {
        title: "Chamomile extract and sleep quality",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2995283/",
      },
      {
        title: "Ashwagandha and sleep improvement",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6750290/",
      },
    ],
    content: `
...
`,
  ...
  {
    id: 8,
    title: "Detoxification and Liver Health with Herbs",
    slug: "detoxification-liver-health-herbs",
    excerpt:
      "Support liver function and natural detoxification with herbs like Milk Thistle, Dandelion Root, and Turmeric. Learn their science-backed benefits and integration into daily routines.",
    category: "Wellness",
    date: "February 25, 2026",
    readTime: "8 min read",
    image: "/images/product-liver-detox.jpg",
    references: [
      {
        title: "Milk Thistle for liver protection",
        url: "https://pubmed.ncbi.nlm.nih.gov/21439143/",
      },
      {
        title: "Dandelion root as a detoxifying agent",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4848652/",
      },
      {
        title: "Turmeric and liver health",
...
`,
  ...
  {
    id: 9,
    title: "Adaptogens for Energy and Vitality: Boosting Resilience Naturally",
    slug: "adaptogens-energy-vitality",
    excerpt:
      "Learn how adaptogenic herbs like Rhodiola, Eleuthero, and Ashwagandha can enhance energy, support mental clarity, and improve resilience to everyday stress.",
    category: "Wellness",
    ...
    references: [
      {
        title: "Rhodiola rosea for fatigue and mental performance",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5370383/",
      },
      {
        title: "Eleuthero and physical endurance",
        url: "https://pubmed.ncbi.nlm.nih.gov/20415522/",
      },
      {
        title: "Adaptogens in modern medicine",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3991026/",
      },
    ],
    content: `
...
`,
  ...
  {
    id: 10,
    title: "Sleep Support and Circadian Rhythm: Natural Ways to Enhance Rest",
    slug: "sleep-support-circadian-rhythm",
    excerpt:
      "Discover natural approaches to support sleep quality, maintain circadian rhythm, and improve overall wellbeing through lifestyle, herbs, and nutrients.",
    category: "Wellness",
    date: "February 15, 2026",
    readTime: "8 min read",
    image: "/images/product-sleep-support.jpg",
    references: [
      {
      ...
      {
        title: "Melatonin supplementation for sleep disorders",
        url: "https://pubmed.ncbi.nlm.nih.gov/30531230/",
      },
      {
        title: "Herbal interventions for sleep improvement",
...
`,
  ...
  {
    id: 11,
    title: "Detox and Liver Health: Supporting Your Body’s Natural Cleansing",
    slug: "detox-liver-health",
    excerpt:
      "Learn natural ways to support liver detoxification, promote metabolic balance, and improve overall wellness using herbs, nutrients, and lifestyle strategies.",
    category: "Wellness",
    ...
    references: [
      {
        title: "Role of the liver in detoxification",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5473052/",
      },
      {
        title: "Herbal support for liver health",
        url: "https://pubmed.ncbi.nlm.nih.gov/30833657/",
      },
      {
        title: "Nutritional interventions for liver protection",
...
`,
...

  {
    id: 12,
    title:
      "Bioavailability and Nutrient Absorption: Maximizing the Benefits of Your Supplements",
    slug: "bioavailability-nutrient-absorption",
    excerpt:
      "Learn how bioavailability impacts nutrient effectiveness, ways to enhance absorption, and practical tips to get the most from your supplements and diet.",
    category: "Wellness",
    date: "February 5, 2026",
    readTime: "8 min read",
    image: "/images/product-bioavailability.jpg",
    references: [
      {
        title: "Bioavailability of vitamins and minerals",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4482448/",
      },
      {
        title: "Enhancing absorption of nutrients",
        url: "https://pubmed.ncbi.nlm.nih.gov/20626188/",
      },
      {
        title: "Factors influencing bioavailability of supplements",
        url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6073406/",
      },
    ],
    content: `
